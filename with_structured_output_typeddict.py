...
class Review(TypedDict):
    # summary: str
    # sentiment: str  # these are simple typed dict 
    Theme: Annotated[list[str],"write down all the themes from the given review in a list"]
    summary: Annotated[str,"A brief summary of the review"]
    sentiment: Annotated[str,"Classify if the review is negative, positive or neutral"]
    Pros: Annotated[Optional[list[str]],"write all the pros from the review in a list"]
    Cons: Annotated[Optional[list[str]],"write all the cond from the review in a list"]
